...
with lib;
let cfg = config.arroquw.hyprland;
in {
  options.arroquw.hyprland = {
    ...
    nvidiaPatches = mkOption {
      ...
      default = false;
      description = ''
        Add enableNvidiaPatches to hyprland config
      '';
    };

    mouseEnablesDpms = mkOption {
      type = types.bool;
      default = true;
      description = ''
        Set hyprland's mouse_move_enables_dpms option
      '';
    };
    ...
    extraConfig = mkOption {
      type = types.str;
      description = ''
        extraConfig to add to hyprland
      '';
      default = "";
    };
  };
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        misc = {
          ...
          mouse_move_enables_dpms = cfg.mouseEnablesDpms;
        };
      ...
      extraConfig = cfg.extraConfig + (import ./config.nix {
        kb_variant = "";
        kb_options = "";
        monitor_config = "";
      });
